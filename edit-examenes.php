...
{
$sql=mysqli_query($con,"update examenes set examen='".$_POST['examen']."', descripcion='".$_POST['descripcion']."', updationDate='$currentTime'where id='$id'");
$_SESSION['msg']="El examen médico se actualizó correctamente!!";
}
...
<html lang="en">
	<head>
		<title>Admin | Editar examen</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Editar examen
</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar examen </h5>
												</div>
...
$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from examenes where id='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?>		<input type="text" name="examen" class="form-control" value="<?php echo $row['examen'];?>" >
	<label for="exampleInputEmail1">
																Editar descripción
															</label>
