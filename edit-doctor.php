...
$sql=mysqli_query($con,"Update doctors set specilization='$docspecialization',doctorName='$docname',cedula='$cedula',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
if($sql)
{
$msg="Doctor fue actualizado correctamente";
...
<div class="form-group">
	...
	<input type="text" name="cedula" class="form-control" value="<?php echo htmlentities($data['cedula']);?>" >
														</div>
